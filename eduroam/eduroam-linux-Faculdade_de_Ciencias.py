...
Config.instname = "Universidade do Porto"
Config.profilename = "Faculdade de Ciências"
Config.url = "your local eduroam® support page"
Config.email = "ci@fc.up.pt"
Config.title = "eduroam CAT"
Config.server_match = "fc.up.pt"
...
Config.user_realm = "fc.up.pt"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius1.fc.up.pt', 'DNS:radius2.fc.up.pt']
